...
- `active_service.json`: aktive Instanz mit PID, Host, Port und Status im Temp-Verzeichnis des Service
- `background_state.json`: persistierter Background-State im Temp-Verzeichnis des Service
