...
class Effect(BaseEffect):
    definition = EffectDefinition(
        ...
        parameter_schema={
            ...
            "duration_ms": EffectParamDefinition(name="duration_ms", type="duration_ms", default=1400, minimum=1, unit="ms"),
    ...
    def render(self, ctx: RenderContext) -> list[int | None]:
        ...
        background_color = _parse_color(
            _param_value(params, "background_color", "base_color"),
            0x120400,
        )
        speed = max(0.1, _parse_float(params.get("speed"), 1.0))
        period_ms = max(1.0, 400.0 / speed)
