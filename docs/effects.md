# Effektsystem und Effektentwicklung

Diese Seite verteilt auf die aktuelle Systemreferenz und die praktische
Entwicklungsdokumentation.

## System verstehen

- [LEFX-V2-Ueberblick](effect-system/README.md)
...
- [Schema V2](effect-system/05_schema_v2.md)
- [Status und Ausblick](effect-system/12_status_and_outlook.md)

## Eigene Definition entwickeln

- [Gefuehrter Einstieg](effect-development/README.md)
