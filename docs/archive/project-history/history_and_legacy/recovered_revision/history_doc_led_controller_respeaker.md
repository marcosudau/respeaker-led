...
Hier werden die Orginal-Auszüge aus dem Planungs- und Entwicklungs-Prozesses des LED-Controller für den ReSpeaker gesammelt.
Es wurde nachträglich zusammen getragen und muss nicht unbedingt vollständig oder chronologisch korrekt sein.
Es muss auch bechtet werden, dass nicht allles was hier steht auch umgesetzt wurde, sondern es sind auch Ideen und Vorschläge enthalten, die nicht umgesetzt wurden.
Dieses Dokument dient nur der Nachvollziehbarkeit des Entwicklungsprozesses. Es ist mit den nummerierten Dateien in "docs\planning" zu betrachten, da es sich um einen Dialog gehandelt hat.

## Übersicht

1. - Eine Effect-Engine vor einem Layer-System

2. - Neue Konzept-Idee + Erste Deployment / Release-Planung   [08__02]

3. - Finalisierung des Konzepts "Effekt-Dateien"  [08__03]

4. - Finalisierung II des Konzepts "Effekt-Dateien"  [08__04]

5. - Konkretisierung Effekt-Planung  + Allg. Sammlung weiterer Ideen
...
## 2. Neue Konzept-Idee für Effekte + Erste Deployment / Release-Planung
...
## 3. Finalisierung des Konzepts "Effekt-Dateien"
...
## 4. Finalisierung II des Konzepts "Effekt-Dateien"
