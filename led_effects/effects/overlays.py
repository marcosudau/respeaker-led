...
from led_effects.effects.basic import BlinkColorEffect
from led_effects.effects.common import _merge_params, _parse_color, _parse_float, _parse_int
...
class DirectionIndicatorEffect(BaseEffect):
    definition = EffectDefinition(
        ...
        parameter_schema={
            "direction_deg": EffectParamDefinition(name="direction_deg", type="float", default=0.0),
        ...
        defaults={"direction_deg": 0.0, "center_color": "#EAF8FF", "side_color": "#7FC9FF"},
    ...
    def render(self, ctx: RenderContext) -> list[int | None]:
        ...
        direction_deg = _parse_float(params.get("direction_deg"), 0.0) % 360.0
...
class WarningFlashEffect(BaseEffect):
    definition = EffectDefinition(
        ...
        parameter_schema={
            ...
            "base_color": EffectParamDefinition(name="base_color", type="color", default="#120400"),
        ...
        defaults={"color": "#FFAA00", "base_color": "#120400", "period_ms": 400, "duty_cycle": 0.5},
        capabilities=EffectCapabilities(
            playback_modes=(PlaybackMode.SINGLE_RUN,),
