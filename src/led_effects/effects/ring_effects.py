...
from .common import _merge_params, _parse_color, _parse_float, _parse_int, _persistent_state_rules
...
def _resolve_target_led(params: dict[str, Any], led_count: int) -> int:
    ...
    return _wrap_index(int(round((direction_deg / 360.0) * led_count)), led_count)
