...
class StateRecordingEffect(BaseEffect):
    definition = EffectDefinition(
        id="state_recording",
        title="StateRecordingEffect",
        description="Live smoke-test effect",
        parameter_schema={
            "color": EffectParamDefinition(name="color", type="color", default="0x11AA55"),
        },
        defaults={"color": "0x11AA55"},
    ...
    def render(self, ctx: RenderContext) -> list[int | None]:
        raw_color = str(ctx.params.get("color", "0x11AA55")).replace("#", "0x")
